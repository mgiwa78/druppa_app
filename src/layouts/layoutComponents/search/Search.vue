...
import Results from "@/layouts/layoutComponents/search/partials/Results.vue";
import PartialMain from "@/layouts/layoutComponents/search/partials/Main.vue";
import Empty from "@/layouts/layoutComponents/search/partials/Empty.vue";
