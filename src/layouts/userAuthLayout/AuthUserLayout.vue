    ...
    >
      ...
      <div class="d-flex flex-center flex-wrap px-5">
        ...
        <div class="d-flex fw-semibold text-primary fs-base">
          <span class="px-5" target="_blank">Terms</span>

          <span class="px-5" target="_blank">Plans</span>

          <span class="px-5" target="_blank">Contact Us</span>
        </div>
        <!--end::Links-->
      </div>
      <!--end::Footer-->
    ...
    >
      ...
      >
        ...
        <router-link to="/" class="mb-0 mb-lg-12">
          <img
            alt="Logo"
            :src="getAssetPath('media/logos/full-logo.png')"
            class="h-90px h-lg-130px"
          />
        </router-link>
        <!--end::Logo-->
        ...
        <img
          ...
          :src="getAssetPath('media/logo/full-logo.png')"
          alt=""
        />
        <!--end::Image-->
