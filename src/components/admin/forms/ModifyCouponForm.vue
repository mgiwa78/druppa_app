<template>
  <div class="card">
    <div class="card-header">
      <h2 class="fw-bold my-10">Edit Coupon</h2>
    </div>
    ...
    <VForm id="kt_modal_add_customer_form" class="form" @submit="submit" :validation-schema="validationSchema"
      ...
      <div class="card-body">
        <div class="mb-5 row">
          <div class="col-12 col-lg-6">
            ...
            <Field type="text" :disabled="true" class="form-control form-control-solid"
              placeholder="Generated Coupon Code" name="couponCode" aria-disabled="true"
              v-model="modifyCouponData.code" />
          ...
          <div class="col-12 col-lg-6 py-9">
            <button @click="generateCouponCode" type="button" id="kt_add_customer_submit"
        ...
        <div class="mb-5 row">
          <div class="col-12 col-md-6 col-lg-3">
            ...
            <Field type="number" class="form-control form-control-solid" placeholder="Enter Coupon Max use" name="maxUse"
              aria-disabled="true" v-model="modifyCouponData.maxUses" />
            <div class="fv-plugins-message-container">
              <div class="fv-help-block">
          ...
          <div class="col-12 col-md-6 col-lg-3">
            <label class="fw-bold required fs-5 fw-semobold mb-2">Current Uses</label>
            <Field type="number" class="form-control form-control-solid" placeholder="Current Uses" name="currentUses"
              disabled="true" v-model="modifyCouponData.currentUses" />
            <div class="fv-plugins-message-container">
              <div class="fv-help-block">
                <ErrorMessage name="currentUses" />
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="col-12 col-lg-6">
            ...
            <div class="position-relative align-items-center">
              ...
              <div class="demo-datetime-pickeqr">
                <el-date-picker v-model="DateDefault" :name="['validFrom', 'validUntil']" @change="handleCouponValidity"
          ...
          <div class="col-12 col-lg-6">
            ...
            <div class="fv row mb-10">
              <div class="col-6 form-check form-check-custom form-check-solid">
                <Field class="form-check-input" name="couponType" v-model="modifyCouponData.couponType" type="radio"
                  value="percentageDiscount" />
                <label class="form-check-label" for="flexCheckDefault">Percentage Discount</label>
              </div>
              <div class="col-6 form-check form-check-custom form-check-solid">
                <Field v-model="modifyCouponData.couponType" class="form-check-input" name="couponType" type="radio"
        ...
        <div class="mb-5 row">
          <div class="col-12 col-lg-6" v-if="modifyCouponData.couponType === 'percentageDiscount'">
            ...
            <Field type="number" class="form-control form-control-solid" placeholder="Enter decrease percentage"
              name="percentageDiscount" aria-disabled="true" max="100" v-model="modifyCouponData.percentageDiscount" />
            <div class="fv-plugins-message-container">
              <div class="fv-help-block">
          ...
          <div class="col-12 col-lg-6" v-if="modifyCouponData.couponType === 'reductionDiscount'">
            ...
            <Field type="number" class="form-control form-control-solid" placeholder="Enter Reduction amount"
              name="reductionDiscount" aria-disabled="true" v-model="modifyCouponData.reductionAmount" />
            <div class="fv-plugins-message-container">
              <div class="fv-help-block">
...
import ModifyCoupon from "@/views/admin/ModifyCoupon.vue";
...
export default defineComponent({
  ...
  setup() {
    ...
    const modifyCouponData = ref<AllTypes.CouponType>(defaultTypes.CouponEmpty);
    ...
    const fetchCustomerProfiles = async () => {
      const customerProfiles = await axios
      ...
      AllCustomers.value = customerProfiles.data;
    };

    const fetchCouponData = async (id) => {
      const couponData: { data: AllTypes.CouponType } = await axios
        .get(API_URL + "coupon/" + id, {
          headers: { Authorization: `Bearer ${token}` },
        })
        .then((response) => response.data)
        .catch((error) => {
    ...
    onMounted(() => {
      ...
      if (couponId) {
        ...
        const test = async () => {
          const couponData = await fetchCouponData(couponId);
          console.log(couponData);


          modifyCouponData.value.code = couponData.code;
          modifyCouponData.value.validFrom = couponData.validFrom;
          modifyCouponData.value.validUntill = couponData.validUntill;
          modifyCouponData.value.couponType = couponData.couponType;
          modifyCouponData.value.percentageDiscount =
            couponData.percentageDiscount;
          modifyCouponData.value.reductionAmount = couponData.reductionAmount;
          modifyCouponData.value.maxUses = couponData.maxUses;
          modifyCouponData.value.forUseBy = couponData.forUseBy;
          modifyCouponData.value.createdAt = couponData.createdAt;
          modifyCouponData.value.currentUses = couponData.currentUses;
        }
        test()
      }
    });
    ...
    const CreateCouponCode = async () => {
      ...
      console.log(modifyCouponData.value);
      formData.append("code", modifyCouponData.value.code);
      formData.append("valid_from", modifyCouponData.value.validFrom);
      formData.append("valid_until", modifyCouponData.value.validUntill);
      formData.append("max_uses", modifyCouponData.value.maxUses);
      formData.append("coupon_type", modifyCouponData.value.couponType);

      modifyCouponData.value.couponType === "percentageDiscount"
        ? formData.append(
          "percentage_discount",
          modifyCouponData.value.percentageDiscount
        )
        : "";
      modifyCouponData.value.couponType === "reductionDiscount"
        ? formData.append(
          "reduction_amount",
          modifyCouponData.value.reductionAmount
        )
        : "";

      formData.append(
        "for_user",
        JSON.stringify([modifyCouponData.value.forUseBy])
      );
    ...
    const handleCouponValidity = (value) => {
      ...
      const formattedStopDate = stopDate
        ...
        .replace("T", " ")
        .slice(0, -5);
      modifyCouponData.value.validFrom = formattedStartDate;
      modifyCouponData.value.validUntill = formattedStopDate;
    };
    ...
    const generateCouponCode = () => {
      ...
      modifyCouponData.value.code = coupon;
    };
    ...
    const DateDefault = ref([
      modifyCouponData.value.validFrom,
      modifyCouponData.value.validUntill,
    ]);
    return {
      modifyCouponData,
      validationSchema,
