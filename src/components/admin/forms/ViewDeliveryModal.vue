    ...
    const viewDeliveryData = computed(() => {
      ...
      if (props.DeliveryData && props.DeliveryData.id) {
        return {
          ...
          driver: {
            id: props.DeliveryData.id || "",
            created_at: props.DeliveryData.driver.created_at || "",
            updated_at: props.DeliveryData.driver.updated_at || "",
            firstName: props.DeliveryData.driver.firstName || "",
            lastName: props.DeliveryData.driver.lastName || "",
            phone_number: props.DeliveryData.driver.phone_number || "",
            email: props.DeliveryData.driver.email || "",
            profile: props.DeliveryData.driver.profile || "",
            city: props.DeliveryData.driver.city || "",
            state: props.DeliveryData.driver.state || "",
            type: props.DeliveryData.driver.type || "",
            title: props.DeliveryData.driver.title || "",
            gender: props.DeliveryData.driver.gender || "",
            licenseNumber: props.DeliveryData.driver.licenseNumber || "",
            licenseExpiration:
              props.DeliveryData.driver.licenseExpiration || "",
            vehicleMake: props.DeliveryData.driver.vehicleMake || "",
            vehicleModel: props.DeliveryData.driver.vehicleModel || "",
            licensePlate: props.DeliveryData.driver.licensePlate || "",
            insurance: props.DeliveryData.driver.insurance || "",
          },
