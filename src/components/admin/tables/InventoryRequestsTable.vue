<template>
        ...
        >
          ...
          <thead>
            <tr class="fw-bold text-muted">
              ...
              <th class="min-w-140px">Delivery Address</th>
            ...
            >
              <tr>
                ...
                <td class="text-dark fw-bold text-hover-primary fs-6">
                  {{
                    inventoryDeliveryRequest.customer.firstName +
                    " " +
                    inventoryDeliveryRequest.customer.lastName
                  }}
                </td>
                <td>
                ...
                <td>
                  <span
                    ...
                    >{{ inventoryDeliveryRequest.requestDescription }}</span
                  >
                </td>

                <td>
                  <span> {{ inventoryDeliveryRequest.status }}</span>
                </td>

                <td class="text-end">
                  <button
                    v-if="inventoryDeliveryRequest.status === 'pending'"
  ...
  <ViewInventoryDeliveryRequest
    :InventoryDeliveryRequest="viewDeliveryData"
  ></ViewInventoryDeliveryRequest>
</template>
...
import ViewInventoryDeliveryRequest from "@/components/admin/forms/ViewInventoryDeliveryRequest.vue";
