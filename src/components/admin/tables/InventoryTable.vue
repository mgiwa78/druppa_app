...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const editProfileData = ref<InventoryType>(InventoryEmpty);
    const viewInventoryData = ref<InventoryType>(InventoryEmpty);

    const dataToDisplay = ref<Array<InventoryType> | null>([]);
    ...
    const updateEditProfile = async (inventory: InventoryType) => {
      editProfileData.value = inventory;
    };
    const updateViewProfile = async (inventory: InventoryType) => {
