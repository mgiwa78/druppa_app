                  ...
                  <tr>
                    ...
                    <td class="text-gray-800">
                      {{
                        ...
                        ", " +
                        InvoiceData?.customer_order.pickup_city
                      }}
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td class="text-gray-800">
                      {{
                        ...
                        ", " +
                        InvoiceData?.customer_order.dropOff_city
                      }}
                    </td>
                  </tr>
                  <!--end::Row-->
              ...
              <div class="flex-equal">
                ...
                <table class="table fs-6 fw-semobold gs-0 gy-2 gx-2 m-0">
                  ...
                  <tr>
                    ...
                    <td class="text-gray-800 min-w-200px">
                      <a href="#" class="text-gray-800 text-hover-primary">{{
                        InvoiceData?.customer_order.service_rendered
                      }}</a>
                    </td>
                  </tr>
                  <!--end::Row-->
                  ...
                  <tr>
                    ...
                    <td class="text-gray-800">
                      {{ InvoiceData?.customer_order.payment_method }}
                    </td>
                  </tr>
                  <!--end::Row-->
                  ...
                  <tr>
                    <td class="text-gray-400">Expected:</td>
                    <td class="text-gray-800">
                      {{ InvoiceData?.customer_order.expected_delivery_date }}
                    </td>
                  </tr>
                  <!--end::Row-->
                </table>
              ...
              <table class="table align-middle table-row-dashed fs-6 gy-4 mb-0">
                ...
                <thead>
                  ...
                  >
                    ...
                    <th class="min-w-125px">Paystack_ID</th>
                ...
                <tbody class="fw-semobold text-gray-800">
                  <tr>
                    ...
                    <td>
                      {{ InvoiceData?.payment.paystack_refrence_id }}
                    </td>
