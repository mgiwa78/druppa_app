<template>
  <div class="card card-flush" style="max-height: 503.66px">
    <!--begin::Header-->
    <div class="card-header pt-7">
      <!--begin::Title-->
      <h3 class="card-title align-items-start flex-column">
        <span class="card-label fw-bold text-gray-800">Delivery Stats</span>
        ...
        <table class="table table-row-dashed align-middle gs-0 gy-3 my-0">
          ...
          <thead>
            <tr class="fs-7 fw-bold text-gray-400 border-bottom-0">
              ...
              <th class="p-0 pb-3 min-w-100px text-end">ADDRESS</th>
