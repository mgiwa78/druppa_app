        ...
        <table class="table table-row-bordered table-row-gray-100 align-middle gs-0 gy-3">
          ...
          <thead>
            <tr class="fw-bold text-muted">
              ...
              <th class="min-w-120px">Order Type</th>
          ...
          <tbody>
            <template v-for="order in dataToDisplay"
              ...
              <tr>
                ...
                <td>
                  <span class="text-dark fw-bold text-hover-primary d-block mb-1 fs-6">{{ order.order_type }}</span>
                </td>
                <td>
                ...
                <td>
                  <span :class="`badge-light-${statusFilter[order.status]}`"
